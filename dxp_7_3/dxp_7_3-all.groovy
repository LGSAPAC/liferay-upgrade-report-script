...
// the function 'invoke__1_infra_groovy' will be invoked at the very end of the 'dxp_7_3-all.groovy'
...
def invoke__2_data_groovy(Map<String, Object> uasContext) {
    ...
    try {
//__GRADLE_COMMENT__ import com.liferay.app.builder.service.AppBuilderAppLocalServiceUtil;
...
// data_app_builder_apps_count
def appBuilderCount = AppBuilderAppLocalServiceUtil.getAppBuilderAppsCount();

println UASUtils.toCSVLine('data_app_builder_apps_count', "${appBuilderCount}", "");
...
// the function 'invoke__2_data_groovy' will be invoked at the very end of the 'dxp_7_3-all.groovy'
...
// the function 'invoke__3_database_info_groovy' will be invoked at the very end of the 'dxp_7_3-all.groovy'
...
def defaultThemesList = [ ~/liferay\/speedwell-theme\/\d*\.\d*\.\d*\/war/, ~/liferay\/minium-theme\/\d*\.\d*\.\d*\/war/, ~/liferay\/classic-theme\/\d*\.\d*\.\d*\/war/, ~/liferay\/admin-theme\/\d*\.\d*\.\d*\/war/ ]
...
// the function 'invoke__4_custom_code_groovy' will be invoked at the very end of the 'dxp_7_3-all.groovy'
